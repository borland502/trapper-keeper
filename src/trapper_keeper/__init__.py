# https://raw.githubusercontent.com/srstevenson/xdg-base-dirs/main/src/xdg_base_dirs/__init__.py
# @author Jeremy Hettenhouser
# Added unofficial xdg dirs for bin ~/.local/bin and lib ~/.local/lib
...
def xdg_bin_home() -> Path:
  """Return a Path corresponding to XDG_BIN_HOME."""
  return _path_from_env("XDG_BIN_HOME", Path.home() / ".local" / "bin")


def xdg_lib_home() -> Path:
  """Return a Path corresponding to XDG_LIB_HOME."""
  return _path_from_env("XDG_LIB_HOME", Path.home() / ".local" / "lib")
